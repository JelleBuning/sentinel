...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mycelium.Api.Domain.Entities.Device", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mycelium.Api.Domain.Entities.DeviceDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mycelium.Api.Domain.Entities.DeviceDisk", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mycelium.Api.Domain.Entities.DeviceSecurity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mycelium.Api.Domain.Entities.DeviceSoftware", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mycelium.Api.Domain.Entities.Organisation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mycelium.Api.Domain.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mycelium.Api.Domain.Entities.Device", b =>
                {
                    b.HasOne("Mycelium.Api.Domain.Entities.DeviceDetails", "DeviceDetails")
                        .WithMany()
                        .HasForeignKey("DeviceDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mycelium.Api.Domain.Entities.DeviceSecurity", "DeviceSecurity")
                        .WithMany()
                        .HasForeignKey("DeviceSecurityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mycelium.Api.Domain.Entities.Organisation", null)
                        .WithMany("Devices")
            ...
            modelBuilder.Entity("Mycelium.Api.Domain.Entities.DeviceDisk", b =>
                {
                    b.HasOne("Mycelium.Api.Domain.Entities.Device", null)
                        .WithMany("Disks")
