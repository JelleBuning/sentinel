...
using Mycelium.Api.Application.Commands.Devices.Ping;
using Mycelium.Api.Application.Commands.Devices.Register;
using Mycelium.Api.Application.Commands.Devices.Update.DeviceInformation;
using Mycelium.Api.Application.Commands.Devices.Update.SecurityInformation;
using Mycelium.Api.Application.Commands.Devices.Update.SoftwareInformation;
using Mycelium.Api.Application.Commands.Devices.Update.StorageInformation;
